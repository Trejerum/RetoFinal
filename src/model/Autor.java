...
/**
 * La clase Autor contiene la información de todos los autores de los que hay libros en la librería.
 * @author equipo B
 *
 */
public class Autor {
	...
	/**
	 * 
	 * @param codAutor : El codigo de autor es el identificador que tiene cada autor y es único.
