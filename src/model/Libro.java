...
public class Libro {
	...
	/**
	 * 
	 * @param isbn             : El ISBN diferencia cada libro de los demás al ser
	 *                         cada ISBN único.
	 ...
	 * @param descuento        : En caso de haber oferta, el atributo descuento
	 *                         contiene el porcentaje de reducción de precio de un
	 *                         libro.
	 * @param stock            : Indica el número de existencias de un libro en la
	 *                         librería
	 */
