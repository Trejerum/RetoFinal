...
/**
 * Esta ventana da la bienvenida al usuario y da una breve expliacion de lo que
 * la aplicacion sirve
 * 
 * @author EquipoB
 *
...
public class InicioUser extends JFrame implements ActionListener {
	...
	public InicioUser(String usuario) {
		...
		/**
		 * Aquí de sefinen los botones del menú. Se introducen los valores de tamaño,
		 * color de fondo y se indica una imagen que hace de icono.
		 */
		// Botón HOME
		btnHome = new JButton("");
		...
		lblAcabasDeEntrar = new JLabel(
				"Acabas de entrar a la liber\u00EDa virtual. Esta aplicaci\u00F3n tiene diferentes funciones:");
		...
		lbllaEstrellaSirve = new JLabel(
				"- La estrella sirve para ver los libros que se encuentran entre los Best Sellers");
		...
		lblLaLupa = new JLabel(
				"- La lupa sirve para hacer una busqueda sobre algun libro que le pueda interesar o para ver tus libros recomendados");
		...
		lblPerfil = new JLabel(
				"- Las personas sirven para acceder a tu perfil y desde ahi puedes modificar tus datos personales");
