...
/**
 * Esta ventana sirve de buscador para el usuario, puede buscar cualquier libro
 * o sus recomendados
 * 
 * @author EquipoB
 *
...
public class BusquedaUser extends JFrame implements ActionListener {
	...
	/**
	 * Esta funcion sirve para ir a ventana de compra y para que te lleve el isbn y
	 * el usuario
	 */
	public void comprar() {
		try {
