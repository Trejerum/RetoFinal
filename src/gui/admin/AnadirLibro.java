...
public class AnadirLibro extends JFrame implements ActionListener {
	...
	/**
	 * Esta funcion sirve para pasar un genero de la combo box al textField de
	 * genero
	 */
	...
	/**
	 * Comprueba si el textField del genero que quiere crear esta vacio o no,
	 * despues si ese genero ya esta creado en la tabla y si todo es correcto los
	 * inserta en la combobox
	 */
	...
	/**
	 * Comprueba si el textField del nombre del autor y del codigo del autor que
	 * quiere crear esta vacio o no, despues si ese autor ya esta creado en la tabla
	 * y si todo esta correcto los inserta en la combobox
	 */
	...
	/**
	 * Esta funcion inserta los datos que hemos introducido del libro en la tabla de
	 * libros
	 */
